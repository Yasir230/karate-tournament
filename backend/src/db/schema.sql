-- Karate Tournament Management System - Database Schema
...
CREATE INDEX IF NOT EXISTS idx_athletes_age_class ON athletes(age_class);
...
CREATE INDEX IF NOT EXISTS idx_certificates_athlete_id ON certificates(athlete_id);
